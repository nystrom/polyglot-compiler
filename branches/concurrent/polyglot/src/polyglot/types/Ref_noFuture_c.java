...
public class Ref_noFuture_c<T> extends Object implements Ref<T>, Serializable {
	...
	public Ref_noFuture_c(T v) {
		this(v, true);
	}

	public Ref_noFuture_c(T v, boolean forced) {
		this.v = v;
		this.forced = forced;
		this.started = forced;
		// this.future = null;
	...
	public Ref_noFuture_c() {
		this((Ref.Callable<T>) null, null);
	}

	public Ref_noFuture_c(final Ref.Callable<T> callable, funicular.Clock clock) {
		this.v = null;
		this.forced = false;
		this.started = false;
