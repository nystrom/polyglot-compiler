...
import polyglot.types.ConstructorAsTypeTransform;
 ...
 *
 * Overview: 
 * A SyntheticClassType represents a class that has been generated by the compiler
 * to represent for example an instantiation of a parameterized class. 
 **/
public class SyntheticClassType_c extends ClassType_c implements ParsedClassType, JL5Type
{   
    protected SyntheticClassType_c() {
	super();
    }
    ...
    public ClassType flags(Flags flags) {
    	SyntheticClassType_c t = (SyntheticClassType_c) copy();
        t.flags = flags;
        return t;
    }
    ...
    public SyntheticClassType_c(ClassDef def) {
        this(def.typeSystem(), def.position(), Types.ref(def));
    }

    public SyntheticClassType_c(TypeSystem ts, Position pos, Ref<? extends ClassDef> def) {
        super(ts, pos, def);
    }
