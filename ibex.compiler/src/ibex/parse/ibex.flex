...
%{
    ...
    private Token xid() {
        return new Identifier(pos(), mangle(yytext()), sym.IDENTIFIER);
    }
    ...
    private String mangle(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (c == '_') sb.append(c);
            if (c == '~') sb.append("_tilde");
            if (c == '!') sb.append("_bang");
            if (c == '@') sb.append("_at");
            if (c == '#') sb.append("_hash");
            if (c == '$') sb.append("_dollar");
            if (c == '%') sb.append("_percent");
            if (c == '^') sb.append("_caret");
            if (c == '&') sb.append("_amp");
            if (c == '*') sb.append("_star");
            if (c == '(') sb.append("_lp");
            if (c == ')') sb.append("_rp");
            if (c == '-') sb.append("_minus");
            if (c == '+') sb.append("_plus");
            if (c == '=') sb.append("_eq");
            if (c == '[') sb.append("_lb");
            if (c == ']') sb.append("_rb");
            if (c == '{') sb.append("_lc");
            if (c == '}') sb.append("_rc");
            if (c == '\\') sb.append("_backslash");
            if (c == '|') sb.append("_bar");
            if (c == ':') sb.append("_colon");
            if (c == ';') sb.append("_semicolon");
            if (c == '\'') sb.append("_q");
            if (c == '"') sb.append("_qq");
            if (c == '<') sb.append("_lt");
            if (c == '>') sb.append("_gt");
            if (c == ',') sb.append("_comma");
            if (c == '.') sb.append("_dot");
            if (c == '/') sb.append("_slash");
            if (c == '?') sb.append("_question");
        }
        return sb.toString();
    }
...
<YYINITIAL> {
    ...
    /* Ibex-specific operators */
    "::="  { return op(sym.COLONCOLONEQ); }
    "**"   { return op(sym.MULTMULT);    }
    ".."   { return op(sym.DOTDOT);    }
