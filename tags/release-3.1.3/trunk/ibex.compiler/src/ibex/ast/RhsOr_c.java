...
public class RhsOr_c extends RhsExpr_c implements RhsOr {
    ...
    public static RhsExpr coerce(RhsExpr e, Type type, ContextVisitor tc) throws SemanticException {
        ...
        IbexTypeSystem ts = (IbexTypeSystem) tc.typeSystem();
        if (ts.isSubtype(e.type(), type, tc.context()))
            return e;
        if (type.isVoid() || e.type().isVoid())
            return e;
    ...
    static Type lca(RhsExpr e, Type t1, Type t2, ContextVisitor tc) throws SemanticException {
        ...
        if (t1.isNumeric() && t2.isNumeric()) {
            ...
            // - Otherwise, binary numeric promotion (Sec. 5.6.2) is applied to
            // the
        ...
        if (t1.isNull())
            return ts.nullable(t2);
        if (t2.isNull())
            return ts.nullable(t1);

        if (t1 instanceof TupleType && t2.isPrimitive())
            return ts.Object();
        if (t2 instanceof TupleType && t1.isPrimitive())
            return ts.Object();
        if (t1 instanceof TupleType && t2.isReference())
            return ts.Object();
        if (t2 instanceof TupleType && t1.isReference())
            return ts.Object();
        ...
        // type (call this latter type T) by assignment conversion (Sec. 5.2);
        // the
